...
INSERT INTO Recordlabel VALUES (null, 'Warner Brothers');
...
INSERT INTO Album
	SELECT null,
		   ...
		   a.ArtistId,
		   g.GenreId
	FROM Recordlabel r, Artist a, Genre g WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" AND r.RecordLabel = "American";
...
INSERT INTO Album
	SELECT null,
		   ...
		   a.ArtistId,
		   g.GenreId
	FROM Recordlabel r, Artist a, Genre g WHERE a.ArtistName = "Mayer Hawthorne" AND g.Label = "Soul" AND r.Recordlabel = "Stones Throw Records";
...
INSERT INTO Album VALUES (null, "Revolver", '08/05/1966', 2083, 3, 6, 2);
INSERT INTO Album VALUES (null, "Sgt. Pepper's Lonely Hearts Club Band", '06/01/1967', 2392, 3, 6, 2);
INSERT INTO Album VALUES (null, "Magical Mystery Tour", '11/27/1967', 1148, 2, 7, 2);

INSERT INTO Album VALUES (null, 'Screaming for Vengeance', '06/17/1982', 2322, 6, 1, 5);
INSERT INTO Album VALUES (null, 'Point of Entry', '02/26/1981', 2262, 2, 7, 5);
INSERT INTO Album VALUES (null, 'Defenders of the Faith', '01/04/1984', 2383, 6, 1, 5);

INSERT INTO Album VALUES (null, 'Round About Midnight', '03/06/1957', 2327, 6, 24, 4);
INSERT INTO Album VALUES (null, 'Miles Ahead', '10/21/1957', 2132, 6, 24, 4);
INSERT INTO Album VALUES (null, 'Milestones', '09/02/1958', 2856, 6, 24, 4);

INSERT INTO Album VALUES (null, "Moanin' in the Moonlight", '05/14/1959', 2033, 4, 7, 3);
INSERT INTO Album VALUES (null, "Howlin' Wolf", '10/21/1957', 1917, 4, 7, 3);
INSERT INTO Album VALUES (null, "The Howlin' Wolf Album", '09/02/1969', 2459, 4, 7, 3);

INSERT INTO Album
  SELECT null, "Eliminator", '3/23/1983', 2668,
    r.RecordLabelId, a.ArtistId, g.GenreId
FROM Recordlabel r, Artist a, Genre g
WHERE r.Recordlabel = "SST" AND a.ArtistName = "ZZTop" AND g.Label = "Rock" ;
...
INSERT INTO Album VALUES (null, "Damaged", '12/05/1981', 2098, 2, 7, 8);
INSERT INTO Album VALUES (null, "TV Party", '07/12/1982', 409, 2, 7, 8);
INSERT INTO Album VALUES (null, "Everything Went Black", '12/03/1982', 3718, 2, 7, 8);
...
INSERT INTO Song
	SELECT null,
		   ...
		   a.ArtistId,
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="SST" 
	AND a.ArtistName = "Black Flag" 
	AND g.Label = "Punk"
	AND al.Title = "Everything Went Black";
...
INSERT INTO Song
	SELECT null,
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="SST" AND a.ArtistName = "Black Flag" AND g.Label = "Punk" AND al.Title = "Everything Went Black";
...
INSERT INTO Song
	SELECT null,
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="SST" AND a.ArtistName = "Black Flag" AND g.Label = "Punk" AND al.Title = "TV Party";
...
INSERT INTO Song
	SELECT null,
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="Warner Brothers" AND a.ArtistName = "ZZTop" AND g.Label = "Rock" AND al.Title = "Eliminator";
...
INSERT INTO Song
	SELECT null,
       ...
       SUBSTR(ABS(RANDOM())||'', 0, 4),
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="Parlophone" AND a.ArtistName = "Beatles" AND g.Label = "Pop" AND al.Title = "Revolver";
...
INSERT INTO Song
	SELECT null,
       ...
       SUBSTR(ABS(RANDOM())||'', 0, 4),
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="Def Jam" AND a.ArtistName = "Beatles" AND g.Label = "Pop" AND al.Title = "Revolver";
...
INSERT INTO Song
	SELECT null,
       ...
       SUBSTR(ABS(RANDOM())||'', 0, 4),
		   ...
		   al.AlbumId
	FROM RecordLabel r, Artist a, Genre g, Album al
	WHERE r.RecordLabel ="Def Jam" AND a.ArtistName = "Jay Z" AND g.Label = "Rap" AND al.Title = "The Black Album";
...
JOIN Album al ON s.AlbumId = al.AlbumId
	JOIN RecordLabel r ON r.RecordLabelId = al.RecordLabelId
